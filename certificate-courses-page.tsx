...
export default function CertificateCoursesPage() {
  ...
  const certificateCategories = [
    { id: "safety", name: "안전관리", icon: "fas fa-shield-alt", imageUrl: "/uploads/photo0.jpg" },
    { id: "environment", name: "환경관리", icon: "fas fa-leaf", imageUrl: "/uploads/photo1.jpg" },
    { id: "quality", name: "품질관리", icon: "fas fa-award", imageUrl: "/uploads/photo2.jpg" },
    { id: "information", name: "정보보안", icon: "fas fa-lock", imageUrl: "/uploads/photo3.jpg" },
    { id: "construction", name: "건설관리", icon: "fas fa-hard-hat", imageUrl: "/uploads/photo4.jpg" },
    { id: "fire", name: "소방안전", icon: "fas fa-fire-extinguisher", imageUrl: "/uploads/photo5.jpg" }
  ];
              ...
              {certificateCategories.map((category) => (
                <Link key={category.id} href={`/certificate-courses?category=${category.id}`}>
                  <div className="text-center group cursor-pointer">
                    ...
                    <div className="text-xs text-gray-500 mt-1">{getCategoryCount(category.id)}개 과정</div>
                  </div>
                </Link>
              ))}
            </div>
            ...
            <TabsContent value="popular" className="mt-6">
              {isLoading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold text-gray-600 mb-2">등록된 자격증 과정이 없습니다</h3>
                  <p className="text-gray-500">새로운 자격증 과정이 곧 추가될 예정입니다.</p>
                </div>
              )}
            </TabsContent>
