...
export default function ProfessionalDevelopmentPage() {
  ...
  const developmentFields = [
    { 
      id: "교육혁신", 
      name: "교육혁신", 
      count: courses.filter(c => c.title.includes("혁신") || c.title.includes("변화")).length,
    ...
    { 
      id: "디지털교육", 
      name: "디지털교육", 
      count: courses.filter(c => c.title.includes("디지털") || c.title.includes("AI") || c.title.includes("온라인")).length,
    ...
    { 
      id: "교수법", 
      name: "교수법", 
      count: courses.filter(c => c.title.includes("교수법") || c.title.includes("수업")).length,
    ...
    { 
      id: "평가방법", 
      name: "평가방법", 
      count: courses.filter(c => c.title.includes("평가") || c.title.includes("측정")).length,
    ...
    { 
      id: "학습자중심", 
      name: "학습자중심", 
      count: courses.filter(c => c.title.includes("학습자") || c.title.includes("학생")).length,
    ...
    { 
      id: "융합교육", 
      name: "융합교육", 
      count: courses.filter(c => c.title.includes("융합") || c.title.includes("통합")).length,
  ...
  const filteredCourses = courses.filter(course => {
    ...
    const matchesField = selectedField === "" || selectedField === "all" || 
                        course.title.includes(selectedField) || course.description.includes(selectedField);
      ...
      <main className="container mx-auto px-4 py-8 pb-4">
                  ...
                  <CardContent className="p-0">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-green-50 p-4 rounded-lg">
                        <h4 className="font-medium text-green-800 mb-2">1단계: 이론</h4>
                        <p className="text-sm text-green-600">학습자 중심 교수법 이론과 원리 학습</p>
                      </div>
                      <div className="bg-blue-50 p-4 rounded-lg">
                        <h4 className="font-medium text-blue-800 mb-2">2단계: 실습</h4>
                        <p className="text-sm text-blue-600">다양한 교수기법 실습과 적용</p>
                      </div>
                      <div className="bg-purple-50 p-4 rounded-lg">
                        <h4 className="font-medium text-purple-800 mb-2">3단계: 평가</h4>
                        <p className="text-sm text-purple-600">교수법 역량 인증과 피드백</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
        ...
        <section className="mb-0">
          <div className="bg-purple-50 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-2">학습 로드맵</h2>
