...
import SeminarCategoryPage from "@/pages/seminar-category-page";
...
import StudyAbroadDetailPage from "@/pages/study-abroad-detail-page";
import OverseasCategoryPage from "@/pages/overseas-category-page";
