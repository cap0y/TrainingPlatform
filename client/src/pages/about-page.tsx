...
import { 
  Building2, MapPin, Phone, Mail, Globe, Users, Award, Target,
  Calendar, CheckCircle, ArrowRight, Star, BookOpen, GraduationCap,
  ...
  const coreValues = [
    {
      ...
      title: "혁신",
      description: "최신 기술과 교육 방법론을 결합하여 지속적으로 혁신하는 교육 서비스를 제공합니다."
    },
    {
      icon: <Heart className="h-8 w-8 text-red-600" />,
      title: "신뢰",
      description: "투명하고 정직한 운영을 통해 고객과의 신뢰 관계를 구축합니다."
    },
    {
      icon: <Zap className="h-8 w-8 text-yellow-600" />,
      title: "전문성",
      description: "교육 분야의 전문 지식과 경험을 바탕으로 최고 품질의 서비스를 제공합니다."
    },
    {
      icon: <Users className="h-8 w-8 text-green-600" />,
      title: "협력",
      description: "고객, 파트너, 임직원 모두와 함께 성장하는 상생의 가치를 추구합니다."
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              지누켐은 2020년 설립된 교육 전문 기업으로, 혁신적인 온라인 교육 플랫폼을 통해 
              양질의 연수과정, 세미나, 해외연수 프로그램을 제공하고 있습니다. 
              우리는 교육의 디지털 전환을 선도하며, 학습자 중심의 맞춤형 교육 서비스로 
              개인과 조직의 성장을 지원합니다.
            </p>
          </div>
            ...
            <Card className="h-full">
              ...
              <CardContent>
                <p className="text-lg text-gray-700 leading-relaxed">
                  <strong className="text-blue-600">"교육의 경계를 허물고, 모든 사람이 언제 어디서나 
                  최고 품질의 교육을 받을 수 있는 세상을 만든다"</strong>
                </p>
                <p className="mt-4 text-gray-600">
                  우리는 기술과 교육의 융합을 통해 학습의 새로운 패러다임을 제시하고, 
                  글로벌 교육 생태계의 혁신을 이끌어가겠습니다.
                </p>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <span className="text-gray-700">개인 맞춤형 학습 경험 제공</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-600 mt-1 flex-shrink-0" />
                    <span className="text-gray-700">최신 교육 기술과 콘텐츠 개발</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-600 mt-1 flex-shrink-0" />
                    <span className="text-gray-700">글로벌 교육 네트워크 구축</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-600 mt-1 flex-shrink-0" />
                    <span className="text-gray-700">지속가능한 교육 생태계 조성</span>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">지누켐이 추구하는 4가지 핵심 가치입니다</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">지누켐의 성장 여정을 소개합니다</p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">지누켐이 제공하는 다양한 교육 서비스입니다</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">지누켐과 함께하고 싶으시다면 언제든 연락주세요</p>
          </div>
                  ...
                  <div className="p-6">
                    <div className="space-y-3 text-sm text-gray-600">
                      <div className="flex items-start space-x-2">
                        ...
                        <p><strong>대중교통:</strong> 진주시외버스터미널에서 시내버스 이용 (약 15분)</p>
                      </div>
                      <div className="flex items-start space-x-2">
                        <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>자가용:</strong> 진주IC에서 진주대로 방면으로 약 10분</p>
                      </div>
                      <div className="flex items-start space-x-2">
                        <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                        <p><strong>주차:</strong> 창업보육센터 내 주차장 이용 가능</p>
                      </div>
                    </div>
                    <div className="mt-4 pt-4 border-t">
                      <Button 
                        variant="outline" 
                        className="w-full"
                        onClick={() => window.open('https://maps.google.com/maps?daddr=경상남도+진주시+진주대로+501', '_blank')}
                      >
