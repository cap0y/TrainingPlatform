  ...
  const faqs = [
    {
      id: 1,
      category: "course",
      question: "연수과정 신청은 어떻게 하나요?",
      answer:
        "연수과정 신청은 로그인 후 원하는 과정을 선택하여 '수강 신청' 버튼을 클릭하시면 됩니다. 결제 완료 후 수강이 가능합니다.",
    },
    {
      id: 2,
      category: "course",
      ...
      answer:
        "과정 이수 기준(출석률 80% 이상)을 충족하시면 과정 종료 후 7일 이내에 이메일로 수료증이 발송됩니다.",
    },
    {
      id: 3,
      category: "payment",
      ...
      answer:
        "신용카드, 계좌이체, 카카오페이, 네이버페이 등 다양한 결제 방법을 지원합니다.",
    },
    {
      id: 4,
      category: "payment",
      ...
      answer:
        "과정 시작 전 100% 환불, 과정 진행률 30% 미만 시 70% 환불, 30% 이상 시 환불 불가합니다.",
    },
    {
      id: 5,
      category: "technical",
      ...
      answer:
        "브라우저를 최신 버전으로 업데이트하거나 다른 브라우저를 사용해보세요. 문제가 지속되면 고객센터로 문의해주세요.",
    },
    {
      id: 6,
      category: "account",
    ...
    },
    {
      id: 7,
      category: "general",
      question: "연수과정 수강 기간은 얼마나 되나요?",
      answer:
        "과정별로 다르며, 대부분 4주~12주 과정으로 구성되어 있습니다. 각 과정 상세 페이지에서 확인하실 수 있습니다.",
    },
    {
      id: 8,
      category: "general",
      ...
      answer:
        "네, 모바일 웹브라우저 및 전용 앱을 통해 언제 어디서나 수강하실 수 있습니다.",
    },
  ];
        ...
        <div className="relative container mx-auto px-4">
          <div className="text-center">
            ...
            <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
              궁금한 점이 있으시면 언제든지 문의해주세요. 친절하고 전문적인
              상담을 제공합니다.
            </p>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50">
                    <div>
                      <h3 className="font-medium">새로운 연수과정 추가 안내</h3>
      ...
      <Dialog open={inquiryDialogOpen} onOpenChange={setInquiryDialogOpen}>
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setInquiryForm((prev) => ({ ...prev, type: value }))
                }
              >
                <SelectTrigger>
                  <SelectValue />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setInquiryForm((prev) => ({ ...prev, title: e.target.value }))
                }
          ...
          <DialogFooter>
            ...
            <Button onClick={handleInquirySubmit}>문의 제출</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
