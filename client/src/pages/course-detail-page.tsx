...
const CourseDetailPage: React.FC = () => {
  ...
  const { data: relatedCourses = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await fetch(
        `/api/courses?category=${encodeURIComponent(course.category)}&limit=4&exclude=${courseId}`,
        {
          credentials: "include",
        },
      );
  ...
  useEffect(() => {
    if (user && courseId) {
      ...
      fetch(`/api/courses/${courseId}/wishlist/status`, {
        ...
        .then((response) =>
          response.ok ? response.json() : { isInWishlist: false },
        )
      ...
      fetch(`/api/cart/items/status?courseId=${courseId}`, {
        ...
        .then((response) =>
          response.ok ? response.json() : { isInCart: false },
        )
  ...
  const migrateLocalStorageData = async () => {
    ...
    try {
      ...
      const localVideos = JSON.parse(
        localStorage.getItem(completedVideosKey) || "[]",
      );
      const localQuizzes = JSON.parse(
        localStorage.getItem(completedQuizzesKey) || "[]",
      );
  ...
  const parsedCurriculum =
    course.curriculumItems && course.curriculumItems.length > 0
                        ...
                        questions: [
                          {
                            ...
                            explanation:
                              "2025 교육과정 개정의 핵심은 학생 중심의 맞춤형 교육입니다.",
                          },
                          {
                            id: "q2",
                            question:
                              "개정 교육과정에서 중요하게 다루는 역량 중심 교육이 맞습니까?",
                            type: "true-false",
                            correctAnswer: "true",
                            explanation:
                              "역량 중심 교육은 개정 교육과정의 핵심 요소입니다.",
                          },
                        ],
                      },
                    ]
                          ...
                          questions: [
                            {
                              id: "q1",
                              question:
                                "학생 중심 수업에서 가장 중요한 요소는?",
                              type: "short-answer",
                              correctAnswer: "참여",
                              explanation:
                                "학생의 적극적인 참여가 학생 중심 수업의 핵심입니다.",
                            },
                          ],
                        },
                      ]
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 p-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  <i
                    className={`${isInWishlist ? "fas fa-heart" : "far fa-heart"} mr-2`}
                  ></i>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="prose max-w-none">
                    {showCourseEditModal ? (
                      ...
                      <div className="space-y-4 text-gray-700 leading-relaxed">
                        <p className="text-lg">
                          {course?.description ||
                            "2025 교육과정 개정안에 따라 새롭게 도입되는 역량을 갖춘 인재를 양성하기 위한 종합적인 학습프로그램입니다."}
                        </p>
                      </div>
                    )}
                  </div>
                  ...
                  <Card className="p-6 mt-8">
                    ...
                    {showCourseEditModal ? (
                      <Textarea
                        ...
                        onChange={(e) =>
                          handleCourseUpdate("objectives", e.target.value)
                        }
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 leading-relaxed">
                          다양한 에듀테크 도구를 활용한 창의적이고 효과적인 수업
                          방법을 학습합니다.
                        </p>
                      </div>
                    </div>
                    ...
                    return (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {materialsToShow.map((material: any) => (
                          <div
                            key={material.id}
                            className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer group transition-colors"
                          >
                    ...
                    <div className="mt-6 border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-400 transition-colors">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-xs text-gray-400 mt-2">
                          지원 형식: PDF, DOC, DOCX, PPT, PPTX, XLSX, ZIP (최대
                          10MB)
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-6 bg-gray-50">
                      ...
                      <div className="bg-white rounded-lg p-4 border border-gray-200">
                        ...
                        <Textarea
                          ...
                          onChange={(e) =>
                            handleCourseUpdate("curriculum", e.target.value)
                          }
                          className="min-h-[100px]"
                          placeholder="차시별 교육 내용을 한 줄씩 입력하세요"
                        />
                        <p className="text-xs text-gray-500 mt-2">
                          각 차시별 내용을 한 줄씩 입력하세요. 예: 1차시 -
                          교육과정 개정 개요
                        </p>
                      </div>
                    </div>
                                  ...
                                  <div className="space-y-2">
                                    {item.videos.map(
                                      (video: any, videoIndex: number) => (
                                        <div
                                          key={video.id}
                                          className="flex items-center space-x-2 bg-red-50 p-2 rounded border border-red-100"
                                        >
                                  ...
                                  <div className="space-y-2">
                                    {item.quizzes.map(
                                      (quiz: any, quizIndex: number) => (
                                        <div
                                          key={quiz.id}
                                          className="flex items-center space-x-2 bg-green-50 p-2 rounded border border-green-100"
                                        >
                                    ...
                                    <div className="flex items-center space-x-3">
                                      {(() => {
                                        ...
                                        const completedItems =
                                          (week.videos?.filter((v: any) =>
                                            completedVideos.has(
                                              `${weekIndex}-${v.id}`,
                                            ),
                                          ).length || 0) +
                                          (week.quizzes?.filter((q: any) =>
                                            completedQuizzes.has(
                                              `${weekIndex}-${q.id}`,
                                            ),
                                          ).length || 0);
                                        const progress =
                                                          ...
                                                          try {
                                                            ...
                                                            if (response.ok) {
                                                              ...
                                                              if (
                                                                ...
                                                                console.log(
                                                                  `저장된 진도율 복원: ${videoKey} = ${data.itemProgress[videoKey]}%`,
                                                                );
                                                              }
                                                            }
                                                          } catch (error) {
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-shrink-0">
                        <img
                          src={
                            ...
                            `https://i.pravatar.cc/200?img=${Math.floor(Math.random() * 70) + 1}&rnd=${Math.random()}`
                          }
                          ...
                          onError={(e) => {
                            ...
                            target.onerror = null;
                            target.src =
                              "https://via.placeholder.com/200x240?text=강사";
                          }}
                        />
                      </div>
                      ...
                      <div className="flex-1">
                        <div className="mb-3">
                          ...
                          <p className="text-sm text-blue-600 mb-2">강사</p>
                        </div>
                      ...
                      <div className="px-6 py-4 bg-gray-50">
                        <div className="flex">
                          ...
                          <p className="text-gray-700">
                            네, 본 연수는 교육부 인정 연수로 3학점이 부여됩니다.
                            연수 이수 후 교육청 및 소속 기관에 학점 인정 신청이
                            가능합니다.
                          </p>
                        </div>
                      </div>
          ...
          <div className="lg:col-span-1">
            <div
              className={`${isSticky ? "sticky top-4" : ""} transition-all duration-300`}
            >
              {/* 수강 신청 카드 */}
              <Card className="bg-white rounded-xl shadow-md overflow-hidden mb-4">
                <div className="p-6">
                  ...
                  >
                    <i
                      className={`${isInCart ? "fas fa-check" : "fas fa-shopping-bag"} mr-2`}
                    ></i>
              ...
              {isEnrolled && (
                <Card className="bg-white rounded-xl shadow-md overflow-hidden mb-4">
                  <div className="p-6">
                    ...
                    {(() => {
                      // 전체 아이템 수 계산
                      const totalVideos = parsedCurriculum.reduce(
                        (acc: number, week: any) =>
                          acc + (week.videos?.length || 0),
                        0,
                      );
                      const totalQuizzes = parsedCurriculum.reduce(
                        (acc: number, week: any) =>
                          acc + (week.quizzes?.length || 0),
                        0,
                      );
                      ...
                      const completedItems =
                        completedVideoCount + completedQuizCount;
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div className="text-center">
                              ...
                              {/* 현재 시청 중인 동영상 정보 */}
                              {(() => {
                                const watchingVideos = Object.entries(
                                  videoProgress,
                                ).filter(
                                  ([key, progress]) =>
                                    progress > 0 &&
                                    progress < 100 &&
                                    !completedVideos.has(key),
                                );
                                if (watchingVideos.length > 0) {
                                  const [videoKey, progress] =
                                    watchingVideos[0];
                                  return (
                                ...
                                <div className="text-lg font-bold text-green-600">
                                  {(() => {
                                    const completedWeeks =
                                      parsedCurriculum.filter(
                                        (week: any, weekIndex: number) => {
                                          const weekTotalItems =
                                            (week.videos?.length || 0) +
                                            (week.quizzes?.length || 0);
                                          if (weekTotalItems === 0)
                                            return false;
                ...
                <div className="p-6">
                  ...
                  <div className="bg-indigo-50 rounded-lg p-4 mb-4">
                    ...
                    <p className="text-sm text-gray-700">
                      본 연수는 교육부 장관이 인정하는 연수로, 이수 시 3학점이
                      인정됩니다.
                    </p>
                  </div>
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex text-yellow-400 text-xs">
                                  {[...Array(5)].map((_, i) => (
                                    <i
                                      key={i}
                                      className={`fas fa-star ${i < 4 ? "" : "text-gray-300"}`}
                                    ></i>
                                  ))}
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    {(() => {
                      ...
                      // 전체 학습 시간 계산 (분 단위)
                      const totalMinutes = parsedCurriculum.reduce(
                        (acc: number, week: CurriculumWeek) => {
                          const videoMinutes =
                            week.videos?.reduce(
                              (sum: number, video: VideoItem) => {
                                const duration = video.duration || "0분";
                                return (
                                  sum +
                                  parseInt(
                                    duration.replace(/[^0-9]/g, "") || "0",
                                  )
                                );
                              },
                              0,
                          ...
                          const quizMinutes = (week.quizzes?.length || 0) * 10; // 퀴즈당 평균 10분
                          return acc + videoMinutes + quizMinutes;
                        },
                        0,
                      );

                      // 하루 2시간 학습 기준으로 필요한 총 일수 계산
                      const daysNeeded = Math.ceil(totalMinutes / 120); // 120분 = 2시간

                      // 시작일 (현재 날짜)
                      const startDate = new Date();

                      // 종료일 (시작일 + 필요한 일수 + 여유 기간)
                      const endDate = new Date(startDate);
                      endDate.setDate(endDate.getDate() + daysNeeded + 14); // 2주 여유 기간 추가

                      // 과제 제출 기한 (종료일 5일 전)
                      const assignmentDate = new Date(endDate);
                      assignmentDate.setDate(endDate.getDate() - 5);

                      // 수료증 발급일 (종료일 다음날)
                      const certificateDate = new Date(endDate);
                      certificateDate.setDate(endDate.getDate() + 1);
                        ...
                        <>
                          <div className="border-l-4 border-indigo-600 pl-4">
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                              <i className="fas fa-info-circle mr-1"></i>총
                              학습시간: {Math.ceil(totalMinutes / 60)}시간{" "}
                              {totalMinutes % 60}분
                            </div>
                          </div>
                          <div className="border-l-4 border-green-600 pl-4">
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                              ...
                              예상 학습 기간: {daysNeeded}일 (하루 2시간 기준)
                            </div>
                          </div>
            ...
            <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 mt-1">
                  {formatPrice(
                    course?.discountPrice || course?.price || 120000,
                  )}
                  원
                </p>
              </div>
