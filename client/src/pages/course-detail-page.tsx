...
const CourseDetailPage: React.FC = () => {
  ...
  const [courseIntro, setCourseIntro] = useState({
    description:
      "2025 교육과정 개정안은 미래 사회가 요구하는 역량을 갖춘 인재를 양성하기 위한 중요한 변화입니다. 본 연수는 교육과정 개정안의 배경과 주요 내용을 체계적으로 이해하고, 이를 학교 현장에 효과적으로 적용할 수 있는 실질적인 방법을 제공합니다.",
    objectives: [
    ...
    features: [
      {
        ...
        title: "최신 교육과정 반영",
        description:
          "2025 개정 교육과정의 최신 내용을 반영하여 현장에서 바로 적용 가능한 지식 제공",
      },
      {
        icon: "fas fa-users",
        title: "전문가 멘토링",
        description:
          "교육과정 전문가의 실시간 질의응답과 피드백을 통한 심층적 학습 지원",
      },
      {
        icon: "fas fa-laptop",
        title: "실습 중심 학습",
        description:
          "이론 학습 후 실제 교육과정 설계 실습을 통한 실무 역량 강화",
      },
      {
        icon: "fas fa-certificate",
        title: "학점 인정",
        description:
          "교육부 인정 3학점 부여로 교원 자격 갱신 및 승진에 활용 가능",
      },
    ],
    recommendations: [
  ...
  const reviews = [
    {
      ...
      date: "2025.06.10",
      content:
        "교육과정 개정안에 대해 체계적으로 이해할 수 있었습니다. 특히 실습 중심의 강의가 매우 도움이 되었습니다.",
      helpful: 12,
    },
    {
      id: 2,
      ...
      date: "2025.06.08",
      content:
        "전문가의 상세한 설명과 현장 적용 사례가 풍부해서 좋았습니다. 다음 연수도 기대됩니다.",
      helpful: 8,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              <div className="mb-4">
                <Badge className="bg-blue-100 text-blue-600 mb-2">
                  {courseInfo.type}
                </Badge>
      ...
      {/* Sticky Navigation */}
      <div
        className={`bg-white border-b ${isSticky ? "fixed top-0 left-0 right-0 z-50 shadow-md" : ""}`}
      >
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="intro" className="space-y-8">
                ...
                <Card className="p-6">
                  ...
                  <ul className="space-y-2">
                    {courseIntro.recommendations.map(
