...
export default function SeminarDetailPage() {
  ...
  const seminarData = {
    ...
    description:
      "교육의 미래를 논하는 국내 최대 규모의 교육학회입니다. 최신 교육 동향과 연구 결과를 공유하며, 전국의 교육 전문가들이 모여 미래 교육의 방향성을 모색합니다.",
    longDescription:
      "한국교육학회 춘계학술대회는 매년 국내외 교육 전문가들이 모여 교육 분야의 최신 연구 성과를 공유하고 토론하는 중요한 학술 행사입니다. 올해는 '교육의 미래: 디지털 전환과 인간 중심 교육'을 주제로 진행됩니다.\n\n이번 대회에서는 AI와 빅데이터를 활용한 개인 맞춤형 교육, 메타버스와 가상현실을 활용한 몰입형 학습, 코로나19 이후 변화된 교육 환경에 대한 심도 있는 논의가 이루어질 예정입니다.\n\n참가자들은 주제 발표, 포스터 세션, 분과별 토론 등을 통해 교육 현장의 실제적인 문제들을 함께 해결해 나가는 소중한 시간을 갖게 될 것입니다.",
    date: "2025.07.15-16",
    ...
    program: [
      {
        ...
        sessions: [
          ...
          {
            time: "13:30-15:00",
            title: "세션 1: AI와 개인 맞춤형 교육",
            type: "세션",
            speaker: "이AI 박사 (KAIST)",
          },
          { time: "15:00-15:30", title: "휴식" },
          {
            time: "15:30-17:00",
            title: "세션 2: 메타버스와 몰입형 학습",
            type: "세션",
            speaker: "박가상 교수 (연세대)",
          },
      ...
      },
      {
        ...
        sessions: [
          ...
          {
            time: "11:00-12:30",
            title: "분과별 토론: 교육 현장의 과제와 해결방안",
            type: "토론",
          },
          { time: "12:30-14:00", title: "점심 식사" },
          {
            time: "14:00-15:30",
            title: "종합 토론: 교육의 미래 방향성",
            type: "종합토론",
          },
          { time: "15:30-16:00", title: "휴식" },
          {
            time: "16:00-17:00",
            title: "폐회식 및 차기 학회 안내",
            type: "폐회식",
          },
        ],
      },
    ...
    faq: [
      {
        ...
        answer:
          "네, 사전 등록이 필수입니다. 현장 등록도 가능하지만 사전 등록 시 할인 혜택이 있습니다.",
      },
      {
        question: "주차 공간이 제공되나요?",
        answer:
          "네, 서울대학교 교육연구원 주차장을 이용하실 수 있습니다. 주차 공간이 한정되어 있으니 대중교통 이용을 권장합니다.",
      },
      {
        question: "참가증명서는 어떻게 발급받나요?",
        answer:
          "학회 종료 후 이메일로 전자 참가증명서가 발송됩니다. 필요시 현장에서 종이 증명서도 발급 가능합니다.",
      },
    ],
  };
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl text-white">
                ...
                <div className="flex items-center gap-2 mb-4">
                  <Badge
                    className={`${getStatusColor(seminarData.status)} text-white`}
                  >
                    {seminarData.status}
                  </Badge>
                  <Badge
                ...
                <div className="flex flex-wrap gap-6 text-sm">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span>
                      {seminarData.participants}/{seminarData.maxParticipants}명
                    </span>
                  </div>
                  <div className="flex items-center space-x-2">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${(seminarData.participants / seminarData.maxParticipants) * 100}%`,
                      }}
                    />
                  </div>
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold text-blue-600">
                      {seminarData.maxParticipants - seminarData.participants}명
                    </span>
                  </div>
                </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">
                        {seminarData.startTime} - {seminarData.endTime}
                      </div>
                    </div>
                  </div>
                  <Separator />
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    <div className="font-medium">
                      {seminarData.organizerInfo.name}
                    </div>
                  </div>
                  <div>
                    <div className="text-gray-600">
                      연락처: {seminarData.organizerInfo.contact}
                    </div>
                    <div className="text-gray-600">
                      이메일: {seminarData.organizerInfo.email}
                    </div>
                  </div>
