            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl text-white">
                ...
                <div className="flex items-center gap-2 mb-4">
                  <Badge
                    className={`${getStatusColor(seminar.isActive || false)} text-white`}
                  >
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-gray-600">
                      일시: {formatDate(seminar.date.toString())}{" "}
                      {formatTime(seminar.date.toString())}
                    </p>
                    {seminar.location && (
                    ...
                    {seminar.programSchedule.map((schedule, index) => {
                      ...
                      return (
                        <div key={schedule.id} className="relative">
                          ...
                          <div
                            className={`relative pl-12 pr-4 py-4 rounded-lg border-l-4 ${getTypeColor(schedule.type)} transition-all hover:shadow-md`}
                          >
                            {/* 시간 아이콘 */}
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-gray-600">
                          세션{" "}
                          {
                            seminar.programSchedule.filter(
                              (s) => s.type === "session",
                            ).length
                          }
                          개
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    <div className="text-gray-600">
                      연락처: {seminar.contactPhone || "02-1234-5678"}
                    </div>
                    <div className="text-gray-600">
                      이메일: {seminar.contactEmail || "info@example.com"}
                    </div>
                  </div>
                  <Button
                    variant="outline"
