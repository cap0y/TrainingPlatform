  ...
  const faqItems = [
    {
      ...
      answer: "행사 3일 전까지 취소 시 전액 환불되며, 이후에는 환불이 불가합니다. 취소는 마이페이지 > 신청내역에서 가능합니다."
    },
    {
      question: "참가 확인증은 어떻게 받을 수 있나요?",
      answer: "행사 종료 후 이메일로 자동 발송되며, 마이페이지 > 수료증 메뉴에서도 다운로드 가능합니다."
    },
    {
      question: "주차는 가능한가요?",
      answer: "행사장 내 주차장을 이용하실 수 있으며, 주차권은 행사장 안내데스크에서 발급받으실 수 있습니다."
    },
    {
      question: "학생 할인은 어떻게 적용받나요?",
      answer: "학생 할인은 현재 재학 중인 대학(원)생에게 적용됩니다. 행사 당일 학생증을 지참해주세요."
    },
    {
      question: "자료집은 제공되나요?",
      answer: "행사 자료집은 PDF로 참가자 이메일로 발송되며, 현장에서는 간략한 프로그램 안내서만 제공됩니다."
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center">
            <a href="/" className="flex items-center">
              ...
              <span className="text-xl font-bold text-gray-800">에듀플랫폼</span>
            </a>
            
            <nav className="hidden md:flex space-x-6 ml-8">
              <a href="/" className="text-gray-600 hover:text-blue-600 font-medium">홈</a>
              <a href="/training" className="text-gray-600 hover:text-blue-600 font-medium">연수 프로그램</a>
              <a href="/courses" className="text-gray-600 hover:text-blue-600 font-medium">교육과정</a>
              <a href="/seminars" className="text-blue-600 font-medium">세미나</a>
              <a href="/notices" className="text-gray-600 hover:text-blue-600 font-medium">공지사항</a>
            </nav>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-6">미래 교육의 방향과 혁신적인 교수법을 함께 탐구합니다</p>
              ...
              <TabsContent value="overview" className="mt-6 space-y-6">
                <Card className="p-6">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    급변하는 교육 환경 속에서 교육자들이 직면한 새로운 도전과 기회를 함께 탐구하는 자리입니다. 
                    최신 교육 트렌드와 혁신적인 교수법을 통해 미래 교육의 방향을 제시하고, 
                    실제 현장에서 적용 가능한 실무 노하우를 공유합니다.
                  </p>
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      },
                      {
                        ...
                        description: "인공지능 기술이 가져올 교육 패러다임의 변화와 교육자의 역할"
                      },
                      {
                        time: "15:30-15:45",
                        title: "휴식",
                      ...
                      },
                      {
                        ...
                        description: "학습자 개별 특성을 고려한 맞춤형 교육과정 설계 실무"
                      },
                      {
                        time: "16:45-17:45",
                      ...
                      <div key={index} className="border-l-4 border-blue-500 pl-6">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          {item.speaker && (
                            <Badge className="bg-blue-100 text-blue-600">{item.speaker}</Badge>
                          )}
                        </div>
                ...
                <Card className="p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gray-700">서울특별시 강남구 테헤란로 152 강남컨벤션센터 3층</p>
                    </div>
                    <div>
          ...
          <div className="lg:col-span-1">
            <Card className="p-6 sticky top-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  <Label className="text-sm font-medium mb-3 block">참가 유형</Label>
                  <RadioGroup 
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-lg font-bold text-blue-600">
                      {prices[formData.participantType as keyof typeof prices].toLocaleString()}원
                    </span>
                  </div>
                </div>
