          ...
          {isLoading ? (
            ...
            <div className="col-span-full text-center py-12">
              ...
              <p className="text-gray-500 mb-4">
                {searchQuery ? "검색 조건을 변경하거나 " : ""}새로운 세미나가 곧
                추가될 예정입니다.
              </p>
            ...
            sortedSeminars.map((seminar) => (
              ...
              >
                <div className="relative">
                  <img
                    src={
                      seminar.imageUrl || "/uploads/images/course-default.jpg"
                    }
                    alt={seminar.title}
                ...
                <CardContent className="p-4">
                  ...
                  <Link href={`/seminars/${seminar.id}`}>
                    <Button className="w-full">세미나 신청</Button>
                  </Link>
                </CardContent>
              </Card>
            ))
