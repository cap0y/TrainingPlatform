...
export default function EnhancedCourseDetailPage() {
  ...
  const courseData = {
    ...
    reviewCount: 78,
    imageUrl:
      "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&h=450&fit=crop&crop=center",
  };
      ...
      lessons: [
        {
          ...
          icon: Video,
          description:
            "교육과정 개정의 역사적 배경과 사회적 맥락을 이해합니다.",
          thumbnail:
        ...
        },
        {
          ...
          icon: Video,
          description:
            "미래 사회 변화에 따른 교육과정 개정의 필요성을 탐구합니다.",
          thumbnail:
        ...
        },
        {
          ...
          icon: Video,
          description:
            "세계 각국의 교육과정 개혁 사례를 분석하고 시사점을 도출합니다.",
          thumbnail:
      ...
      lessons: [
        {
          ...
          icon: Video,
          description:
            "미래 사회가 요구하는 핵심 역량과 교육과정의 연계를 학습합니다.",
          thumbnail:
        ...
        },
        {
          ...
          icon: Video,
          description:
            "새로운 교수학습 방법과 과정 중심 평가의 방향을 제시합니다.",
          thumbnail:
  ...
  const instructors = [
    {
      ...
      profile:
        "교육과정 전문가로 20년 이상의 연구 경력을 보유하고 있으며, 교육부 교육과정 개정 위원회 위원장을 역임했습니다.",
      imageUrl:
    ...
    },
    {
      ...
      profile:
        "교육정책 및 교육평가 분야의 전문가로 다수의 국가 교육정책 연구를 주도했습니다.",
      imageUrl:
        "https://images.unsplash.com/photo-1494790108755-2616c64e0ce7?w=200&h=200&fit=crop&crop=face",
    },
  ];
            ...
            {lesson.questions?.map((question: any, qIndex: number) => (
              <Card key={question.id} className="p-4">
                ...
                <Button
                  className="mt-4"
                  onClick={() =>
                    handleQuizSubmit(weekIndex, lessonIndex, question.id)
                  }
                ...
                {quizResults[question.id] !== undefined && (
                  <div
                    className={`mt-2 text-sm ${quizResults[question.id] ? "text-green-600" : "text-red-600"}`}
                  >
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <Card
                className={`${isSticky ? "fixed top-4 w-80" : ""} transition-all duration-300`}
              >
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {courseData.credit}학점
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-600">총 시간</span>
                        <span className="font-medium">
                          {courseData.totalHours}시간
                        </span>
                      </div>
                    </div>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-gray-600">
                  총 {curriculumData.length}주 과정으로 구성된 체계적인 학습
                  프로그램입니다.
                </p>
              </CardHeader>
              <CardContent>
                        ...
                        <div className="flex items-center justify-between w-full pr-4">
                          <div className="text-left">
                            ...
                            <p className="text-sm text-gray-600">
                              {week.lessons.length}개 강의 • 총{" "}
                              {week.totalDuration}분
                            </p>
                          </div>
                        </div>
                      </AccordionTrigger>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="prose max-w-none">
                  <h2>강의 소개</h2>
                  <p>
                    2025 교육과정 개정안은 미래 사회가 요구하는 역량을 갖춘
                    인재를 양성하기 위한 중요한 변화입니다. 본 연수는 교육과정
                    개정안의 배경과 주요 내용을 체계적으로 이해하고, 이를 학교
                    현장에 효과적으로 적용할 수 있는 실질적인 방법을 제공합니다.
                  </p>
                </div>
              </CardContent>
            </Card>
