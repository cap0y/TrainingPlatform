...
export default function OverseasCategoryPage() {
  ...
  const filteredPrograms = programs.filter((program) => {
    ...
    return (
      matchesCategory && matchesSearch && matchesCountry && isActiveProgram
    );
  });
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center text-sm text-gray-500 mb-8">
          ...
          <Link href="/study-abroad" className="hover:text-blue-600">
            해외연수
          </Link>
          <ChevronRight className="h-4 w-4 mx-2" />
          ...
          {isLoading ? (
            ...
            <div className="col-span-full text-center py-12">
              ...
              <p className="text-gray-500 mb-4">
                {searchQuery ? "검색 조건을 변경하거나 " : ""}새로운 프로그램이
                곧 추가될 예정입니다.
              </p>
                ...
                >
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="flex flex-wrap gap-1 mb-4">
                      <Badge
                        className={`text-xs bg-${categoryData.color}-100 text-${categoryData.color}-800`}
                      >
                        {program.type}
                      </Badge>
                      {program.tags &&
