...
const botResponses = {
  ...
  안녕하세요:
    "안녕하세요! 지누켐 연수플랫폼 AI 상담원입니다. 무엇을 도와드릴까요?",
  ...
  해외연수:
    "해외연수 프로그램은 미국 실리콘밸리, 영국 옥스포드, 일본 도쿄 등 6개국 프로그램을 운영합니다. 기업탐방, 대학연수, 기술체험 등 다양한 형태로 진행됩니다.",
  세미나:
    "세미나는 정기적으로 개최되며, 화학안전, 환경보호, 신기술 동향 등의 주제로 진행됩니다. 참가 신청은 홈페이지에서 가능합니다.",
  ...
  // 회원가입 및 로그인
  회원가입:
    "회원가입은 개인 회원과 기업 회원으로 구분됩니다. 홈페이지 상단의 회원가입 버튼을 클릭하여 진행하실 수 있습니다.",
  로그인:
    "로그인은 홈페이지 상단의 로그인 버튼을 클릭하여 진행하세요. 아이디나 비밀번호를 잊으셨다면 찾기 기능을 이용해 주세요.",
  비밀번호:
    "비밀번호 재설정은 로그인 페이지의 '비밀번호 찾기'를 이용하시거나, 고객센터(055-772-2226)로 문의해 주세요.",

  // 수료증 및 학점
  수료증:
    "프로그램 완료 시 수료증이 발급됩니다. 온라인으로 다운로드 가능하며, 필요시 우편 발송도 가능합니다.",
  학점: "일부 프로그램은 학점 인정이 가능합니다. 각 프로그램 상세 페이지에서 학점 정보를 확인하실 수 있습니다.",
  인증: "저희 교육 프로그램은 관련 기관의 인증을 받은 정식 교육과정입니다.",

  // 연락처 및 고객지원
  연락처:
    "고객센터: 055-772-2226, 이메일: bkim@jinuchem.co.kr, 운영시간: 평일 09:00-18:00입니다.",
  ...
  // 일반적인 질문
  지누켐:
    "지누켐은 화학 안전 교육 전문 기업으로, 다양한 연수 프로그램을 제공하는 전문 교육기관입니다.",
